              ...
              <div className="flex items-center justify-between pt-2 border-t border-gray-200">
                ...
                <button
                  ...
                  className={`px-4 py-2 text-sm font-medium rounded-lg transition-all duration-200 ${
                    category.visible
                      ? 'bg-red-500 text-white hover:bg-red-600 shadow-md hover:shadow-lg disabled:opacity-50'
                      : 'bg-green-500 text-white hover:bg-green-600 shadow-md hover:shadow-lg disabled:opacity-50'
                  }`}
                >
                  {updating === category.name ? (
                    ...
                    <div className="flex items-center space-x-1">
                      ...
                      <span>{category.visible ? 'Ocultar' : 'Mostrar'}</span>
                    </div>
                  )}
                </button>
              </div>
