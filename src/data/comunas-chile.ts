...
export const REGIONES_CHILE: Region[] = [
  ...
  },
  {
    ...
    comunas: [
      ...
      { codigo: "16103", nombre: "Cobquecura" },
      { codigo: "16104", nombre: "Coelemu" },
      { codigo: "16105", nombre: "Coihueco" },
      { codigo: "16106", nombre: "Chillán Viejo" },
      { codigo: "16107", nombre: "El Carmen" },
      { codigo: "16108", nombre: "Ninhue" },
      { codigo: "16109", nombre: "Ñiquén" },
      { codigo: "16110", nombre: "Pemuco" },
      { codigo: "16111", nombre: "Pinto" },
      { codigo: "16112", nombre: "Portezuelo" },
      { codigo: "16113", nombre: "Quillón" },
      { codigo: "16114", nombre: "Quirihue" },
      { codigo: "16115", nombre: "Ránquil" },
      { codigo: "16116", nombre: "San Carlos" },
      { codigo: "16117", nombre: "San Fabián" },
      { codigo: "16118", nombre: "San Ignacio" },
      { codigo: "16119", nombre: "San Nicolás" },
      { codigo: "16120", nombre: "Trehuaco" },
      { codigo: "16121", nombre: "Yungay" }
    ]
  },
  {
    codigo: "11",
...
// Función helper para encontrar región por comuna
export const findRegionByComuna = (comunaNombre: string): Region | undefined => {
  return REGIONES_CHILE.find(region => 
    region.comunas.some(comuna => 
      comuna.nombre.toLowerCase() === comunaNombre.toLowerCase()
    )
  );
};

// Función helper para obtener todas las comunas de una región
export const getComunasByRegion = (regionNombre: string): Comuna[] => {
